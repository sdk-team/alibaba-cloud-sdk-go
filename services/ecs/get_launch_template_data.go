...
type GetLaunchTemplateDataResponse struct {
	*responses.BaseResponse
	...
	LaunchTemplateData LaunchTemplateDataInGetLaunchTemplateData `json:"LaunchTemplateData" xml:"LaunchTemplateData"`
}
...
func CreateGetLaunchTemplateDataRequest() (request *GetLaunchTemplateDataRequest) {
	...
	request.InitWithApiInfo("Ecs", "2014-05-26", "GetLaunchTemplateData", "ecs", "openAPI")
