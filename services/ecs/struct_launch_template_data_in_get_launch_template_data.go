...
// LaunchTemplateDataInGetLaunchTemplateData is a nested struct in ecs response
type LaunchTemplateDataInGetLaunchTemplateData struct {
	...
	SaleStrategy                string                                   `json:"SaleStrategy" xml:"SaleStrategy"`
	...
	DataDisks                   DataDisksInGetLaunchTemplateData         `json:"DataDisks" xml:"DataDisks"`
	NetworkInterfaces           NetworkInterfacesInGetLaunchTemplateData `json:"NetworkInterfaces" xml:"NetworkInterfaces"`
