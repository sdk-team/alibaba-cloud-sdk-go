...
// DescribeForwardTables invokes the ecs.DescribeForwardTables API synchronously
...
// DescribeForwardTablesWithChan invokes the ecs.DescribeForwardTables API asynchronously
...
// DescribeForwardTablesWithCallback invokes the ecs.DescribeForwardTables API asynchronously
...
func CreateDescribeForwardTablesRequest() (request *DescribeForwardTablesRequest) {
	...
	request.InitWithApiInfo("Ecs", "2014-05-26", "DescribeForwardTables", "ecs", "openAPI")
