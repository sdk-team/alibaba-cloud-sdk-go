...
type Task struct {
	...
	SucceededInstanceCount int64                    `json:"SucceededInstanceCount" xml:"SucceededInstanceCount"`
	Status                 string                   `json:"Status" xml:"Status"`
	FailedInstanceCount    int64                    `json:"FailedInstanceCount" xml:"FailedInstanceCount"`
	CommandType            string                   `json:"CommandType" xml:"CommandType"`
	TaskAction             string                   `json:"TaskAction" xml:"TaskAction"`
	ItemLists              ItemListsInCreateAxtTask `json:"ItemLists" xml:"ItemLists"`
	ResultLists            ResultLists              `json:"ResultLists" xml:"ResultLists"`
}
