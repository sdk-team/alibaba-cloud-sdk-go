...
// api document: https://help.aliyun.com/api/r-kvstore/describeengineversion.html
...
request.InitWithApiInfo("R-kvstore", "2015-01-01", "DescribeEngineVersion", "kvstore", "openAPI")
return
}
