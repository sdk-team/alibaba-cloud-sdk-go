...
// DescribeDBInstanceIPArrayList invokes the r_kvstore.DescribeDBInstanceIPArrayList API synchronously
// api document: https://help.aliyun.com/api/r-kvstore/describedbinstanceiparraylist.html
...
// DescribeDBInstanceIPArrayListWithChan invokes the r_kvstore.DescribeDBInstanceIPArrayList API asynchronously
// api document: https://help.aliyun.com/api/r-kvstore/describedbinstanceiparraylist.html
...
// DescribeDBInstanceIPArrayListWithCallback invokes the r_kvstore.DescribeDBInstanceIPArrayList API asynchronously
// api document: https://help.aliyun.com/api/r-kvstore/describedbinstanceiparraylist.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
type DescribeDBInstanceIPArrayListResponse struct {
	*responses.BaseResponse
	...
	SecurityIpGroups SecurityIpGroupsInDescribeDBInstanceIPArrayList `json:"SecurityIpGroups" xml:"SecurityIpGroups"`
}
...
func CreateDescribeDBInstanceIPArrayListRequest() (request *DescribeDBInstanceIPArrayListRequest) {
	...
	request.InitWithApiInfo("R-kvstore", "2015-01-01", "DescribeDBInstanceIPArrayList", "", "")
	return
}
