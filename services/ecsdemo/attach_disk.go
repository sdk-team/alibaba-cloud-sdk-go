...
// AttachDisk invokes the ecsdemo.AttachDisk API synchronously
// api document: https://help.aliyun.com/api/ecsdemo/attachdisk.html
...
// AttachDiskWithChan invokes the ecsdemo.AttachDisk API asynchronously
// api document: https://help.aliyun.com/api/ecsdemo/attachdisk.html
...
// AttachDiskWithCallback invokes the ecsdemo.AttachDisk API asynchronously
// api document: https://help.aliyun.com/api/ecsdemo/attachdisk.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
type AttachDiskRequest struct {
	*requests.RpcRequest
	...
	Aid string `position:"Query" name:"Aid"`
}
...
func CreateAttachDiskRequest() (request *AttachDiskRequest) {
	...
	request.InitWithApiInfo("EcsDemo", "2019-06-20", "AttachDisk", "", "")
	return
}
