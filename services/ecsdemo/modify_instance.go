...
// ModifyInstance invokes the ecsdemo.ModifyInstance API synchronously
// api document: https://help.aliyun.com/api/ecsdemo/modifyinstance.html
...
// ModifyInstanceWithChan invokes the ecsdemo.ModifyInstance API asynchronously
// api document: https://help.aliyun.com/api/ecsdemo/modifyinstance.html
...
// ModifyInstanceWithCallback invokes the ecsdemo.ModifyInstance API asynchronously
// api document: https://help.aliyun.com/api/ecsdemo/modifyinstance.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
type ModifyInstanceResponse struct {
	*responses.BaseResponse
	...
	AnswerList []Answers `json:"AnswerList" xml:"AnswerList"`
}
...
func CreateModifyInstanceRequest() (request *ModifyInstanceRequest) {
	...
	request.InitWithApiInfo("EcsDemo", "2019-06-20", "ModifyInstance", "", "")
	return
}
