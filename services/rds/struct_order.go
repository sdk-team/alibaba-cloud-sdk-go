...
// Order is a nested struct in rds response
type Order struct {
            ...
            DiscountAmount     float64 `json:"DiscountAmount" xml:"DiscountAmount"`
                RuleIds RuleIdsInQueryPriceMultiForDefer `json:"RuleIds" xml:"RuleIds"`
            ActivityInfo ActivityInfo  `json:"ActivityInfo" xml:"ActivityInfo"`
                    Coupons CouponsInQueryPriceMultiForDefer `json:"Coupons" xml:"Coupons"`
}
