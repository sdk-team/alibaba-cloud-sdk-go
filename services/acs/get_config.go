...
// GetConfig invokes the acs.GetConfig API synchronously
// api document: https://help.aliyun.com/api/acs/getconfig.html
...
// GetConfigWithChan invokes the acs.GetConfig API asynchronously
// api document: https://help.aliyun.com/api/acs/getconfig.html
...
// GetConfigWithCallback invokes the acs.GetConfig API asynchronously
// api document: https://help.aliyun.com/api/acs/getconfig.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
*requests.RoaRequest
                    ConfigKey     string `position:"Path" name:"ConfigKey"`
...
request.InitWithApiInfo("Acs", "2015-01-01", "GetConfig", "/PopConfig/[ConfigKey]", "", "")
