...
// DoLogicalDeleteResource invokes the cr.DoLogicalDeleteResource API synchronously
// api document: https://help.aliyun.com/api/cr/dologicaldeleteresource.html
...
// DoLogicalDeleteResourceWithChan invokes the cr.DoLogicalDeleteResource API asynchronously
// api document: https://help.aliyun.com/api/cr/dologicaldeleteresource.html
...
// DoLogicalDeleteResourceWithCallback invokes the cr.DoLogicalDeleteResource API asynchronously
// api document: https://help.aliyun.com/api/cr/dologicaldeleteresource.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateDoLogicalDeleteResourceRequest() (request *DoLogicalDeleteResourceRequest) {
	...
	request.InitWithApiInfo("cr", "2015-05-06", "DoLogicalDeleteResource", "cr", "openAPI")
	return
}
