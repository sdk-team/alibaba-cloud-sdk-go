...
// DoPhysicalDeleteResource invokes the cr.DoPhysicalDeleteResource API synchronously
// api document: https://help.aliyun.com/api/cr/dophysicaldeleteresource.html
...
// DoPhysicalDeleteResourceWithChan invokes the cr.DoPhysicalDeleteResource API asynchronously
// api document: https://help.aliyun.com/api/cr/dophysicaldeleteresource.html
...
// DoPhysicalDeleteResourceWithCallback invokes the cr.DoPhysicalDeleteResource API asynchronously
// api document: https://help.aliyun.com/api/cr/dophysicaldeleteresource.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateDoPhysicalDeleteResourceRequest() (request *DoPhysicalDeleteResourceRequest) {
	...
	request.InitWithApiInfo("cr", "2015-05-06", "DoPhysicalDeleteResource", "cr", "openAPI")
	return
}
