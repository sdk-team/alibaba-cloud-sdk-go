...
// DoCheckResource invokes the cr.DoCheckResource API synchronously
// api document: https://help.aliyun.com/api/cr/docheckresource.html
...
// DoCheckResourceWithChan invokes the cr.DoCheckResource API asynchronously
// api document: https://help.aliyun.com/api/cr/docheckresource.html
...
// DoCheckResourceWithCallback invokes the cr.DoCheckResource API asynchronously
// api document: https://help.aliyun.com/api/cr/docheckresource.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateDoCheckResourceRequest() (request *DoCheckResourceRequest) {
	...
	request.InitWithApiInfo("cr", "2015-05-06", "DoCheckResource", "cr", "openAPI")
	return
}
