...
module.exports = {
    ...
    'go_topic_name': 'SDK_PORTAL_GO',
    'result_topic_name': 'SDK_PORTAL_RESULT',
    'consumer_id': 'GO_CONSUMER_GROUP',
    'reset': 'earliest',
    'repo': path.join('/Users/yangdengyu/github', 'repo'),
    'sdkCoreDir': path.join('/Users/yangdengyu/github', 'repo/go/src/github.com/aliyun/alibaba-cloud-sdk-go'),
    'jarPrefix': '',
    //'ossDir': 'tarfiles',
